<template>
  <div id="themeSetting">
    <v-toolbar color="blue" dark>
      <v-toolbar-title>Установка тем</v-toolbar-title>
    </v-toolbar>
    <v-container>
      <v-layout column>
        <v-flex>
          <v-subheader class="px-1 my-2">Варианты цвета</v-subheader>
          ...
          <div class="theme-options">
            <v-subheader class="px-1 my-2">Опции боковой панели</v-subheader>
            <v-divider></v-divider>
            <div class="my-3">
              <v-btn-toggle v-model="sideBarOption">
                <v-btn flat value="dark">Темная</v-btn>
                <v-btn flat value="light">Светлая</v-btn>
              </v-btn-toggle>
            </div>
          </div>
        </v-flex>
